            ...
            <Card className="bg-card border-white/5 rounded-none shadow-2xl">
              ...
              <CardContent className="p-8 space-y-6">
                <div className="space-y-2">
                  ...
                  <Input value={formData.facebookUrl} onChange={(e) => setFormData({...formData, facebookUrl: e.target.value})} className="bg-black/50 border-white/10 rounded-none" />
                </div>
                <div className="space-y-2">
                  ...
                  <Input value={formData.instagramUrl} onChange={(e) => setFormData({...formData, instagramUrl: e.target.value})} className="bg-black/50 border-white/10 rounded-none" />
                </div>
                <div className="space-y-2">
                  ...
                  <Input value={formData.twitterUrl} onChange={(e) => setFormData({...formData, twitterUrl: e.target.value})} className="bg-black/50 border-white/10 rounded-none" />
                </div>
                <div className="space-y-2">
