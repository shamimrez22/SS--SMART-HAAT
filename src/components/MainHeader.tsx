...
export const MainHeader = memo(() => {
  ...
  return (
    <>
      {/* OUTER FULL-WIDTH BLACK CONTAINER (Makes sides black) */}
      <div className="fixed top-0 left-0 right-0 z-[120] bg-black gpu-accelerated shadow-2xl">
        ...
        <div className="px-2 md:px-12">
          ...
          <div className="overflow-hidden">
            ...
            {/* 2. LIVE STATUS BAR PART (SHUDU AITUKU BLACK) */}
            {settings?.liveStatus && (
              <div className="h-[18px] md:h-[22px] flex items-center overflow-hidden whitespace-nowrap py-0 relative w-full border-t border-white/5 bg-black">
                <div className="flex items-center gap-6 animate-marquee w-full px-4">
                  <div className="flex items-center gap-1.5 text-[7px] md:text-[9px] font-bold uppercase tracking-widest shrink-0 text-white">
                    <Radio className="h-2 w-2 animate-pulse" /> {settings.liveStatusLabel || 'LIVE STATUS:'}
                  </div>
                  <p className="text-[7px] md:text-[9px] font-bold uppercase tracking-[0.15em] flex items-center gap-4 shrink-0 text-white">
